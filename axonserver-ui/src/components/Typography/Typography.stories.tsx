  ...
  <div>
    ...
    <div>
      <Typography addMargin size="m" tag="div">
        div. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos
        blanditiis tenetur
      </Typography>
    </div>
    <div>
      <Typography addMargin size="m" weight="bold" tag="div">
        div. bold. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        Quos blanditiis tenetur
      </Typography>
    </div>
    <div>
      <Typography addMargin size="m" weight="light" color="light" tag="div">
        div. light. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        Quos blanditiis tenetur
      </Typography>
    </div>
    <div>
      <Typography addMargin size="m" weight="lighter" color="lighter" tag="div">
        div. lighter. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        Quos blanditiis tenetur
      </Typography>
    </div>
    <div>
    ...
    <div>
      <Typography addMargin size="m" italic tag="div">
        div. italic. Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        Quos blanditiis tenetur
      </Typography>
    </div>
    <div>
      <Typography addMargin size="m" uppercase tag="span">
        span. uppercase. Lorem ipsum dolor sit amet, consectetur adipisicing
