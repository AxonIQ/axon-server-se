...
/**
 * CLI handler for the upload-plugin command. Adds a plugin to Axon Server. Returns the plugin name and
 * version as defined inside the extension file.
 *
 * @author Marc Gathier
 * @since 4.5
 */
public class UploadPlugin extends AxonIQCliCommand {

    public static void run(String[] args) throws IOException {
        // check args
        CommandLine commandLine = processCommandLine(args[0],
                                                     args,
                                                     CommandOptions.PLUGIN_FILE,
