...
public class CommandOptions {
    ...
    public static final Option NODES = Option.builder("n").required().hasArgs().valueSeparator(',').longOpt("nodes").desc("Member nodes for context").build();
    ...
    public static final Option USER_ROLES = Option.builder("r").required().hasArgs().valueSeparator(',').longOpt("roles").desc("Roles for the user (READ, ADMIN)").build();
