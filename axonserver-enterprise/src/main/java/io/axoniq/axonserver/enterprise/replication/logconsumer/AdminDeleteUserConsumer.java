...
/**
 * Deletes user from the tables used by Axon Server console.
 *
 * @author Marc Gathier
 * @since 4.1
 */
@Component
public class AdminDeleteUserConsumer implements LogEntryConsumer {

    public static final String DELETE_USER = "DELETE_USER";
    private final Logger logger = LoggerFactory.getLogger(AdminDeleteUserConsumer.class);
    private final UserController userController;
    private final ApplicationEventPublisher applicationEventPublisher;

    public AdminDeleteUserConsumer(UserController userController,
