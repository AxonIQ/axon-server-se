...
import static io.axoniq.axonserver.enterprise.cluster.internal.ForwardedQueryResponseUtils.wrapForForwarding;
...
public class RemoteConnection {
    ...
    public synchronized RemoteConnection init() {
        ...
        requestStreamObserver = new ClusterFlowControlStreamObserver(
                stubFactory.messagingClusterServiceStub(clusterNode)
    ...
    private void sendQueryResponse(String client, QueryResponse queryResponse) {
        requestStreamObserver.onNext(ConnectorCommand.newBuilder()
                                                     .setQueryResponse(wrapForForwarding(queryResponse, client))
                                                     .build());
    }
