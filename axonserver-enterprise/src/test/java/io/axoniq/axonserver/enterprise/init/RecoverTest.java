...
public class RecoverTest {
    ...
    private Map<String, JpaRaftGroupNode> raftGroupNodeMap = new HashMap<>();
    ...
    public void setup() throws IOException {
        ...
        JpaRaftGroupNodeRepository jpaRaftGroupNodeRepository = mock(JpaRaftGroupNodeRepository.class);
        ...
        doAnswer(invocation -> {
            Collection<JpaRaftGroupNode> updatedNodes = invocation.getArgument(0);
        ...
        Context context = new Context("sampleContext");
        ...
        clusterNode1.addContext(context, "node1label", Role.PRIMARY);
        clusterNode2.addContext(context, "node2label", Role.PRIMARY);
        clusterNode3.addContext(context, "node3label", Role.PRIMARY);
        ...
        JpaRaftGroupNode raftMember1 = new JpaRaftGroupNode("sampleContext",
                                                            Node.newBuilder()
                                                                ...
                                                                .setHost("hostname1")
                                                                .build());
        JpaRaftGroupNode raftMember2 = new JpaRaftGroupNode("sampleContext",
                                                            Node.newBuilder()
                                                                .setRole(Role.PRIMARY)
                                                                .setNodeName("node2")
                                                                ...
                                                                .setHost("hostname2")
                                                                .build());
        JpaRaftGroupNode raftMember3 = new JpaRaftGroupNode("sampleContext",
                                                            Node.newBuilder()
                                                                .setRole(Role.PRIMARY)
                                                                .setNodeName("node3")
    ...
    private String key(JpaRaftGroupNode raftMember) {
    ...
    public void changeNodeNames() throws IOException {
        ...
        assertEquals(1, newNode1.getContextNames().size());

        assertEquals(3, raftGroupNodeMap.size());

        JpaRaftGroupNode group1 = raftGroupNodeMap.get("sampleContext/node1label");
        assertNotNull(group1);
        assertEquals("newNode1", group1.getNodeName());
        JpaRaftGroupNode group2 = raftGroupNodeMap.get("sampleContext/node2label");
        assertNotNull(group2);
        assertEquals("newNode2", group2.getNodeName());
        JpaRaftGroupNode group3 = raftGroupNodeMap.get("sampleContext/node3label");
    ...
    public void changeHostNames() throws IOException {
        ...
        JpaRaftGroupNode group = raftGroupNodeMap.get("sampleContext/node1label");
        assertNotNull(group);
