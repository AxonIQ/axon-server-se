 ...
 * @author Marc Gathier
 */
public class AdminReplicationGroupSnapshotDataStoreTest {

    private AdminReplicationGroupSnapshotDataStore testSubject;
    ...
    public void setUp() {
        ...
        testSubject = new AdminReplicationGroupSnapshotDataStore("_admin", adminReplicationGroupController);
    }
    ...
    @Test
    public void streamSnapshotDataNoReplicationGroups() {
        SnapshotContext installationContext = new DefaultSnapshotContext(Collections.emptyMap(),
                                                                         Collections.emptyMap(),
                                                                         false,
                                                                         Role.PRIMARY);
