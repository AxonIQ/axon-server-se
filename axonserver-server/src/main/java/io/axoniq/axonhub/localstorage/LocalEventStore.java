...
import io.axoniq.axonhub.localstorage.query.QueryEventsRequestStreamObserver;
 ...
 */
@Component
public class LocalEventStore implements io.axoniq.axonhub.message.event.EventStore, SmartLifecycle {
