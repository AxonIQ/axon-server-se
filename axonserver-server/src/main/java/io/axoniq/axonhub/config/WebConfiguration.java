...
import io.axoniq.axonhub.rest.RestAuthenticationInterceptor;
import io.axoniq.axonhub.serializer.Printable;
import io.axoniq.axonhub.serializer.PrintableSerializer;
...
public class WebConfiguration implements WebMvcConfigurer {
    ...
    public WebConfiguration(AxonHubAccessController axonHubAccessController, MessagingPlatformConfiguration configuration) {
