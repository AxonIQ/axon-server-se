...
import io.axoniq.axonhub.config.FlowControl;
...
import io.axoniq.axonhub.internal.grpc.Permits;
...
public class DataSynchronizationReplica {
    ...
    @Scheduled(fixedRateString = "${axoniq.axonhub.replication-check-rate:1000}", initialDelayString = "${axoniq.axonhub.replication-check-delay:10000}")
