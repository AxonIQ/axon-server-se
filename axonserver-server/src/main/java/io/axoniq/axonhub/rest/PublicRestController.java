...
public class PublicRestController {
    ...
    private ExtendedClusterNode mapExtended(io.axoniq.axonhub.cluster.jpa.ClusterNode me) {
    ...
    private ClusterNode map(io.axoniq.axonhub.cluster.jpa.ClusterNode me) {
