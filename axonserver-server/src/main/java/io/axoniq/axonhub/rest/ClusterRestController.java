...
import io.axoniq.axonhub.grpc.internal.ClusterJoinRequester;
...
public class ClusterRestController {
    ...
    public static class JsonClusterNode {
        ...
        public ClusterNode toClusterNode() {
            return new ClusterNode(name, hostName, internalHostName, grpcPort, internalGrpcPort, httpPort);
        }
    ...
    private static class ClusterJoinRequest {
        @NotEmpty(message = "missing required field: internalHostName")
        private String internalHostName;
