...
public class AxonHubAccessControllerTest {
    private AxonHubAccessController testSubject;
    @Mock
    ...
    @Before
    public void setup() {
        testSubject = new AxonHubAccessController(accessController, pathMappingRepository, messagingPlatformConfiguration, limits);
