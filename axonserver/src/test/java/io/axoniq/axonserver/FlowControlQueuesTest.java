...
public class FlowControlQueuesTest {
    ...
    public void take() throws Exception {
        ClientStreamIdentification one = new ClientStreamIdentification(Topology.DEFAULT_CONTEXT, "one");
    ...
    public void move() throws Exception {
        ClientStreamIdentification one = new ClientStreamIdentification(Topology.DEFAULT_CONTEXT, "one");
        ClientStreamIdentification two = new ClientStreamIdentification(Topology.DEFAULT_CONTEXT, "two");
    ...
    public void queueSoftLimits() {
        ...
        MessagingPlatformException exception = assertThrows(MessagingPlatformException.class,
