...
public class QueryServiceTest {
    ...
    public void disconnectClientStream() {
        CountingStreamObserver<QueryProviderInbound> responseObserver = new CountingStreamObserver<>();
        ...
        assertTrue(responseObserver.error.getMessage().contains("Query stream inactivity"));
    }
}
