...
public class ClientProcessorsByIdentifierTest {
    ...
    private final ClientProcessor blueA =
            new FakeClientProcessor(CLIENT_A, BELONGS_TO_COMPONENT, blue1Info);
    private final ClientProcessor greenA =
            new FakeClientProcessor(CLIENT_A, BELONGS_TO_COMPONENT, green1Info);
    private final ClientProcessor redA =
            new FakeClientProcessor(CLIENT_A, BELONGS_TO_COMPONENT, red1Info);

    private final ClientProcessor blueB =
            new FakeClientProcessor(CLIENT_B, DOES_NOT_BELONG_TO_COMPONENT, blue1Info);
    private final ClientProcessor greenB =
            new FakeClientProcessor(CLIENT_B, DOES_NOT_BELONG_TO_COMPONENT, green1Info);
    private final ClientProcessor redB =
            new FakeClientProcessor(CLIENT_B, DOES_NOT_BELONG_TO_COMPONENT, red1Info);

    private final ClientProcessor blueC =
            new FakeClientProcessor(CLIENT_C, DOES_NOT_BELONG_TO_COMPONENT, blue1Info);
    private final ClientProcessor greenC =
            new FakeClientProcessor(CLIENT_C, DOES_NOT_BELONG_TO_COMPONENT, green1Info);
    private final ClientProcessor redC =
            new FakeClientProcessor(CLIENT_C, DOES_NOT_BELONG_TO_COMPONENT, red1Info);

    private final ClientProcessor blueD =
            new FakeClientProcessor(CLIENT_D, BELONGS_TO_COMPONENT, blue2Info);
    private final ClientProcessor greenD =
            new FakeClientProcessor(CLIENT_D, BELONGS_TO_COMPONENT, green2Info);
    private final ClientProcessor redD =
            new FakeClientProcessor(CLIENT_D, BELONGS_TO_COMPONENT, red2Info);

    private final ClientProcessor blueE =
            new FakeClientProcessor(CLIENT_E, DOES_NOT_BELONG_TO_COMPONENT, blue2Info);
    private final ClientProcessor greenE =
            new FakeClientProcessor(CLIENT_E, DOES_NOT_BELONG_TO_COMPONENT, green2Info);
    private final ClientProcessor redE =
            new FakeClientProcessor(CLIENT_E, DOES_NOT_BELONG_TO_COMPONENT, red2Info);

    private final ClientProcessor blueF =
            new FakeClientProcessor(CLIENT_F, DOES_NOT_BELONG_TO_COMPONENT, blue2Info);
    private final ClientProcessor greenF =
            new FakeClientProcessor(CLIENT_F, DOES_NOT_BELONG_TO_COMPONENT, green2Info);
    private final ClientProcessor redF =
            new FakeClientProcessor(CLIENT_F, DOES_NOT_BELONG_TO_COMPONENT, red2Info);
    ...
    public void iterator() {
        ...
        assertEquals(blueC, iterator.next());
        ...
        assertEquals(redC, iterator2.next());
        assertFalse(iterator2.hasNext());

        ClientProcessorsByIdentifier testSubject3 = new ClientProcessorsByIdentifier(clientProcessors, green1);
        ...
        assertEquals(greenC, iterator3.next());
        assertFalse(iterator3.hasNext());

        ClientProcessorsByIdentifier testSubject4 = new ClientProcessorsByIdentifier(clientProcessors, blue2);
        ...
        assertEquals(blueF, iterator4.next());
        ...
        assertEquals(redF, iterator5.next());
        assertFalse(iterator5.hasNext());

        ClientProcessorsByIdentifier testSubject6 = new ClientProcessorsByIdentifier(clientProcessors, green2);
        ...
        assertEquals(greenF, iterator6.next());
