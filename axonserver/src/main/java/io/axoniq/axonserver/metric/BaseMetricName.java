...
public enum BaseMetricName implements MetricName {
    ...
    SUBSCRIPTION_QUERIES_TOTAL("axon.queries.subscriptionquery.throughput.total",
                               "Total number of subscription queries subscribed"),
    SUBSCRIPTION_QUERIES_DURATION("axon.queries.subscriptionquery.duration",
                                  "Duration of a subscription query connection"),
    SUBSCRIPTION_QUERIES_UPDATES("axon.queries.subscriptionquery.throughput.updates",
                                 "Total number of updates submitted on subscription queries"),
    SUBSCRIPTION_QUERIES_ACTIVE("axon.queries.subscriptionquery.saturation.active",
                                "Active number of subscription queries on this node"),
