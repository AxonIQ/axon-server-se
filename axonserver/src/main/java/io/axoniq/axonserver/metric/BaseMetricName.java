...
public enum BaseMetricName implements MetricName {
    ...
    AXON_SEGMENT_MOVED("file.segment.moved", "Number of event store segment files moved to next tier"),
    AXON_SEGMENT_MOVED_DURATION("file.segment.moved", "Duration of moving event store segment files to next tier"),
