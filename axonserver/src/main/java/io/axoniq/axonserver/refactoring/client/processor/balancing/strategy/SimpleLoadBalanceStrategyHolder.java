...
public class SimpleLoadBalanceStrategyHolder implements LoadBalanceStrategyHolder {
    ...
    public SimpleLoadBalanceStrategyHolder() {
        LoadBalancingStrategy noLoadBalanceStrategy = new LoadBalancingStrategy("default",
                                                                                "Default (disabled)",
                                                                                "NoLoadBalance");
        loadBalancingStrategyMap.put(noLoadBalanceStrategy.name(), noLoadBalanceStrategy);

        LoadBalancingStrategy threadNumber = new LoadBalancingStrategy("threadNumber",
                                                                       "Thread Number",
                                                                       "ThreadNumberBalancingStrategy");
