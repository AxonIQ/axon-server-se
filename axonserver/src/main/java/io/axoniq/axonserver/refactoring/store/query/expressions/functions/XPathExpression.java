...
public class XPathExpression implements Expression {
    ...
    private QName outputType(ExpressionResult outputTypeValue) {
        if (outputTypeValue == null || !outputTypeValue.isNonNull()) {
    ...
    private ExpressionResult toExpressionResult(Object value, ExpressionResult outputTypeValue) {
        ...
        if (value instanceof Number) {
            return new NumericExpressionResult(((Number) value).doubleValue());
        }
        if (value instanceof Text) {
            return new StringExpressionResult(((Text) value).getTextContent());
        }
        if (value instanceof Element) {
            return new XmlExpressionResult(((Element) value));
        }
