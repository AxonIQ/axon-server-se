 ...
 * @author Marc Gathier
 */
public class GrpcCommandDispatcherListener
        extends GrpcFlowControlledDispatcherListener<SerializedCommandProviderInbound, WrappedCommand> {

    private static final Logger logger = LoggerFactory.getLogger(GrpcCommandDispatcherListener.class);

    public GrpcCommandDispatcherListener(FlowControlQueues<WrappedCommand> commandQueues, String queueName,
