...
package io.axoniq.axonserver.refactoring.configuration.topology;
...
public interface AxonServerNode {
    ...
    /**
     * The port number to be used by other nodes in the cluster to connect to this node. This is only used in Enterprise
     * Edition.
     *
     * @return gRPC port number
     */
    ...
    /**
     * Returns a list of all contexts where this node is member of. In Standard Edition this will only contain
     * "default".
     *
     * @return
     */
