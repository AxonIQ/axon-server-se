...
import io.axoniq.axonserver.refactoring.transport.grpc.DirectUpdateHandler;
...
import io.axoniq.axonserver.refactoring.transport.grpc.ReceivingStreamObserver;
import io.axoniq.axonserver.refactoring.transport.grpc.StreamObserverUtils;
...
public class SubscriptionQueryRequestTarget extends ReceivingStreamObserver<SubscriptionQueryRequest> {
    ...
    public SubscriptionQueryRequestTarget(
