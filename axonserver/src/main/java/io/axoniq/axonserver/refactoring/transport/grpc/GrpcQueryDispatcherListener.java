...
import io.axoniq.axonserver.refactoring.messaging.query.QueryRequestValidator;
import io.axoniq.axonserver.refactoring.messaging.query.SerializedQuery;
import io.axoniq.axonserver.refactoring.messaging.query.WrappedQuery;
...
public class GrpcQueryDispatcherListener
        extends GrpcFlowControlledDispatcherListener<QueryProviderInbound, WrappedQuery> implements
