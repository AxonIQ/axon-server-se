...
package io.axoniq.axonserver.refactoring.store.query.result;
...
public class NumericExpressionResult implements ExpressionResult {
    ...
    public ExpressionResult divide(ExpressionResult other) {
        if (other instanceof NumericExpressionResult) {
            return new NumericExpressionResult(value.divide(((NumericExpressionResult) other).value,
    ...
    public ExpressionResult subtract(ExpressionResult other) {
        ...
        throw new IllegalArgumentException(
                "Invalid second parameter for subtract: " + other.getClass().getSimpleName());
    }
    ...
    public ExpressionResult multiply(ExpressionResult other) {
        ...
        throw new IllegalArgumentException(
                "Invalid second parameter for multiply: " + other.getClass().getSimpleName());
    }
