package io.axoniq.axonserver.refactoring.transport.instruction.result;
...
public class InstructionResultSourceFactory implements InstructionResultSource.Factory {
    ...
    private final ConcurrentMap<String, List<InstructionResultSource.ResultSubscriber>> subscribersMap = new ConcurrentHashMap<>();
    ...
    private static class TimeoutResultSubscriber implements InstructionResultSource.ResultSubscriber {

        private final InstructionResultSource.ResultSubscriber delegate;
        private final ScheduledFuture<?> onTimeout;
        private final Consumer<TimeoutResultSubscriber> cancelSubscription;

        private TimeoutResultSubscriber(InstructionResultSource.ResultSubscriber resultSubscriber, Duration timeout,
