...
import io.axoniq.axonserver.refactoring.store.EventStoreValidationException;
...
public class InputStreamTransactionIterator implements TransactionIterator {
    ...
    public InputStreamTransactionIterator(InputStreamEventSource eventSource, long segment, long start,
                                          boolean validating) {
