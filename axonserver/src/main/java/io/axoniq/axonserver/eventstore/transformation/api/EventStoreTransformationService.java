...
public interface EventStoreTransformationService {
     ...
     */
    Mono<String> startTransformation(String context, String description);
    ...
    /**
     * Registers the intent to replace the content of an event when applying the transformation. The caller needs to provide the
     * previous token to ensure that the events to change in the transformation are specified in the correct order.
     * @param context the name of the context
     * @param transformationId the identification of the transformation
     * @param token the token (global position) of the event to delete
     ...
     */
    Mono<Void> cancelTransformation(String context, String transformationId);
     ...
     * @param keepOldVersions option to keep old versions of the event store segments, so that the transformation can be rolled back
     ...
     */
    Mono<Void> applyTransformation(String context, String transformationId, long lastEventToken, boolean keepOldVersions,
                                   String appliedBy);
     ...
     */
    Mono<Void> rollbackTransformation(String context, String transformationId);
     ...
     */
    Mono<Void> deleteOldVersions(String context, String transformationId);
}
