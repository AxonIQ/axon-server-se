...
/**
 * The Spring Security global configuration class. The {@ WebSecurityConfigurerAdapter} based configurer may be
 * plugged in here using {@link #()} to override or extend the default
