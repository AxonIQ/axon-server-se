...
public enum ErrorCode {
    ...
    REPLICATION_GROUP_EXISTS("AXONIQ-1305", Status.ALREADY_EXISTS, HttpStatus.BAD_REQUEST, true),
    ...
    REPLICATION_GROUP_UPDATE_IN_PROGRESS("AXONIQ-2107", Status.NOT_FOUND, HttpStatus.BAD_REQUEST, false),
    REPLICATION_GROUP_NOT_FOUND("AXONIQ-2108", Status.NOT_FOUND, HttpStatus.NOT_FOUND, true),
    ...
    REPLICATION_GROUP_CREATION_NOT_ALLOWED("AXONIQ-2302", Status.PERMISSION_DENIED, HttpStatus.FORBIDDEN, true),
    ...
    COMMAND_DUPLICATED("AXONIQ-4005", Status.INVALID_ARGUMENT, HttpStatus.BAD_REQUEST),
    ...
    QUERY_DUPLICATED("AXONIQ-5007", Status.INVALID_ARGUMENT, HttpStatus.BAD_REQUEST),
    ...
    LIST_AGGREGATE_EVENTS_TIMEOUT("AXONIQ-6002", Status.ABORTED, HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    PLUGINS_DISABLED("AXONIQ-9301", Status.CANCELLED, HttpStatus.INTERNAL_SERVER_ERROR),
