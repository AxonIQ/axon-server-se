...
public class ActiveEventStoreTransformation {
    ...
    private final CloseableIterator<EventWithToken> iterator;


    public ActiveEventStoreTransformation(String id, String context, EventStoreTransformationJpa.Status status,
                                          long lastToken) {
        this(id, context, status, lastToken, null); //TODO why we accept iterator null
    }

    public ActiveEventStoreTransformation(String id, String context, EventStoreTransformationJpa.Status status,
                                          long lastToken,
                                          CloseableIterator<EventWithToken> iterator) {
        this.id = id;
    ...
    public CloseableIterator<EventWithToken> iterator() {
        return iterator;
    }

    public ActiveEventStoreTransformation withIterator(CloseableIterator<EventWithToken> iterator) {
